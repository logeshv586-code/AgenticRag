...
const defaultItems = [
  { icon: <Search />, color: '#22d3ee', label: 'Universal Neural' },
  { icon: <Wand2 />, color: '#a78bfa', label: 'Global Data' },
  { icon: <MessageCircle />, color: '#22c55e', label: 'Cognitive' },
  { icon: <Layers />, color: '#f97316', label: 'Global Context' },
  { icon: <Database />, color: '#fb7185', label: 'Structured Intel' },
  { icon: <Workflow />, color: '#38bdf8', label: 'Synaptic Graph' },
  { icon: <Brain />, color: '#fde047', label: 'Autonomous' },
  { icon: <Cpu />, color: '#60a5fa', label: 'Live Stream' },
  { icon: <Users />, color: '#34d399', label: 'Adaptive Persona' },
  { icon: <Languages />, color: '#f43f5e', label: 'Universal Matrix' },
  { icon: <Mic />, color: '#00b4d8', label: 'Vocal Synth' },
  { icon: <Book />, color: '#eab308', label: 'Verified Intel' },
  { icon: <Shield />, color: '#64748b', label: 'Policy Guard' },
